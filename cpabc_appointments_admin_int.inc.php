 ...
 <div id="metabox_basic_settings" class="postbox" >
  ...
  <div class="inside">
    ...
    <table class="form-table">
        ...
        <td><input type="checkbox" name="enable_paypal" size="40" value="1" <?php if (cpabc_get_option('enable_paypal',CPABC_APPOINTMENTS_DEFAULT_ENABLE_PAYPAL)) echo 'checked'; ?> /></td>
        </tr>    
        ...
        <td> 
           ...
           <br />
           Code: <input type="text" name="cpabc_dc_code" id="cpabc_dc_code" value="" /> &nbsp; &nbsp; &nbsp; 
           Discount %: <input type="text" size="3" name="cpabc_dc_discount" id="cpabc_dc_discount"  value="25" />         &nbsp; &nbsp; &nbsp;   
           Valid until: <input type="text"  size="10" name="cpabc_dc_expires" id="cpabc_dc_expires" value="" />&nbsp; &nbsp; &nbsp; 
           <input type="button" name="cpabc_dc_subccode" id="cpabc_dc_subccode" value="Add" />
           <br />
 ...
 <div id="metabox_basic_settings" class="postbox" >
  ...
  <div class="inside">  
     <table class="form-table">    
        ...
        <td><input type="checkbox" name="enable_reminder" size="40" value="1" <?php if (cpabc_get_option('enable_reminder',CPABC_APPOINTMENTS_DEFAULT_ENABLE_REMINDER)) echo 'checked'; ?> /></td>
        </tr>             
        <tr valign="top">
 ...
 <div id="metabox_basic_settings" class="postbox" >
  ...
  <div class="inside">
     <table class="form-table">    
        ...
        <td><textarea cols="90" wrap="off" rows="15" name="cp_cal_checkboxes"><?php echo cpabc_get_option('cp_cal_checkboxes', CPABC_APPOINTMENTS_DEFAULT_CP_CAL_CHECKBOXES); ?></textarea></td>
        </tr>             
     </table>  
  </div>    
 </div>   
